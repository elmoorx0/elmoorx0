 ...
 *
 * Run: npx tsx --test packages/a11y/tests/a11y-smoke.test.mjs
 */
...
describe("a11y: smoke tests", () => {
  ...
  skip("expected exports are present", () => {
    const missing = ["useFocusTrap", "useFocusReturn", "useLiveRegion", "usePrefersReducedMotion", "useKeyboard", "useOutsideClick", "useId", "aria", "SkipLink"].filter(name => !mod[name]);
  ...
  skip("exported functions are callable", () => {
    ...
    for (const name of ["useFocusTrap", "useFocusReturn", "useLiveRegion", "usePrefersReducedMotion", "useKeyboard", "useOutsideClick", "useId", "aria", "SkipLink"]) {
      const v = mod[name];
  ...
  skip("Accessibility hooks and helpers - basic shape", () => {
