 ...
 *
 * Run: npx tsx --test packages/analyzer/tests/analyzer-smoke.test.mjs
 */
...
describe("analyzer: smoke tests", () => {
  ...
  skip("exported functions are callable", () => {
    ...
    for (const name of ["analyzeProject"]) {
      const v = mod[name];
  ...
  skip("Static analysis - basic shape", () => {
