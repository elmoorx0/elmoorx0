 ...
 *
 * Run: npx tsx --test packages/ar/tests/ar-smoke.test.mjs
 */
...
describe("ar: smoke tests", () => {
  ...
  skip("exported functions are callable", () => {
    ...
    for (const name of ["startARSession", "trackMarker"]) {
      const v = mod[name];
  ...
  skip("Augmented reality - basic shape", () => {
