 ...
 *
 * Run: npx tsx --test packages/cli-pro/tests/cli-pro-smoke.test.mjs
 */
...
describe("cli-pro: smoke tests", () => {
  ...
  skip("exported functions are callable", () => {
    ...
    for (const name of ["commands", "registerProCommands"]) {
      const v = mod[name];
  ...
  skip("Advanced CLI commands - basic shape", () => {
