/**
 * @elmoorx/code-review — smoke tests
 *
 ...
 *
 * Run: npx tsx --test packages/code-review/tests/code-review-smoke.test.mjs
 */
...
describe("code-review: smoke tests", () => {
  ...
  skip("exported functions are callable", () => {
    ...
    for (const name of ["codeReviewer", "reviewCode"]) {
      const v = mod[name];
  ...
  skip("AI code review - basic shape", () => {
