 ...
 *
 * Run: npx tsx --test packages/collab/tests/collab-smoke.test.mjs
 */
...
describe("collab: smoke tests", () => {
  ...
  skip("exported functions are callable", () => {
    ...
    for (const name of ["collabSession", "useCollab", "PresenceBar"]) {
      const v = mod[name];
  ...
  skip("Real-time collaboration - basic shape", () => {
