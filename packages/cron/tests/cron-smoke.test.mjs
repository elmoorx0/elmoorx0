 ...
 *
 * Run: npx tsx --test packages/cron/tests/cron-smoke.test.mjs
 */
...
describe("cron: smoke tests", () => {
  ...
  skip("exported functions are callable", () => {
    ...
    for (const name of ["cron", "createQueue"]) {
      const v = mod[name];
  ...
  skip("Cron scheduler - basic shape", () => {
