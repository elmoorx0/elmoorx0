 ...
 *
 * Run: npx tsx --test packages/edge-db/tests/edge-db-smoke.test.mjs
 */
...
describe("edge-db: smoke tests", () => {
  ...
  skip("exported functions are callable", () => {
    ...
    for (const name of ["connect", "query", "mutation", "transaction", "migrate"]) {
      const v = mod[name];
  ...
  skip("Edge databases - basic shape", () => {
