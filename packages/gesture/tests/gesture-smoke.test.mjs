 ...
 *
 * Run: npx tsx --test packages/gesture/tests/gesture-smoke.test.mjs
 */
...
describe("gesture: smoke tests", () => {
  ...
  skip("exported functions are callable", () => {
    ...
    for (const name of ["touchGestures", "useGesture", "useHandTracking"]) {
      const v = mod[name];
  ...
  skip("Gesture control - basic shape", () => {
