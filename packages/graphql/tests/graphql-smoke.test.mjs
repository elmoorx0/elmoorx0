 ...
 *
 * Run: npx tsx --test packages/graphql/tests/graphql-smoke.test.mjs
 */
...
describe("graphql: smoke tests", () => {
  ...
  skip("exported functions are callable", () => {
    ...
    for (const name of ["gql", "createGraphQLClient", "useQuery", "useMutation"]) {
      const v = mod[name];
  ...
  skip("GraphQL client - basic shape", () => {
