 ...
 *
 * Run: npx tsx --test packages/image/tests/image-smoke.test.mjs
 */
...
describe("image: smoke tests", () => {
  ...
  skip("exported functions are callable", () => {
    ...
    for (const name of ["Image", "Picture", "Source", "BackgroundImage"]) {
      const v = mod[name];
  ...
  skip("Image components - basic shape", () => {
