 ...
 *
 * Run: npx tsx --test packages/perf-ai/tests/perf-ai-smoke.test.mjs
 */
...
describe("perf-ai: smoke tests", () => {
  ...
  skip("exported functions are callable", () => {
    ...
    for (const name of ["perfAI", "predictivePrefetch"]) {
      const v = mod[name];
  ...
  skip("AI performance - basic shape", () => {
