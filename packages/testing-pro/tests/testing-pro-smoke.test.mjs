/**
 * @elmoorx/testing-pro — smoke tests
 *
 ...
 *
 * Run: npx tsx --test packages/testing-pro/tests/testing-pro-smoke.test.mjs
 */
...
describe("testing-pro: smoke tests", () => {
  ...
  skip("exported functions are callable", () => {
    ...
    for (const name of ["e2e", "snapshot", "visual", "mockFn", "mockRequest"]) {
      const v = mod[name];
  ...
  skip("Advanced testing - basic shape", () => {
