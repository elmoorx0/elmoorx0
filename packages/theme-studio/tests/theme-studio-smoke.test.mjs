/**
 * @elmoorx/theme-studio — smoke tests
 *
 ...
 *
 * Run: npx tsx --test packages/theme-studio/tests/theme-studio-smoke.test.mjs
 */
...
describe("theme-studio: smoke tests", () => {
  ...
  skip("exported functions are callable", () => {
    ...
    for (const name of ["presetThemes", "themeManager", "ThemeStudio"]) {
      const v = mod[name];
  ...
  skip("Visual theme editor - basic shape", () => {
