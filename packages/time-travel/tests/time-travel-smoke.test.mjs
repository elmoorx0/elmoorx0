/**
 * @elmoorx/time-travel — smoke tests
 *
 ...
 *
 * Run: npx tsx --test packages/time-travel/tests/time-travel-smoke.test.mjs
 */
...
describe("time-travel: smoke tests", () => {
  ...
  skip("exported functions are callable", () => {
    ...
    for (const name of ["timeTravel", "TimeTravelPanel"]) {
      const v = mod[name];
  ...
  skip("Time-travel debugger - basic shape", () => {
