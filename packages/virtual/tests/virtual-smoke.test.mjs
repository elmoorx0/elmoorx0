 ...
 *
 * Run: npx tsx --test packages/virtual/tests/virtual-smoke.test.mjs
 */
...
describe("virtual: smoke tests", () => {
  ...
  skip("exported functions are callable", () => {
    ...
    for (const name of ["VirtualList", "VariableVirtualList", "VirtualGrid"]) {
      const v = mod[name];
  ...
  skip("Virtualization - basic shape", () => {
