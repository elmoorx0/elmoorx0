/**
 * @elmoorx/vite-plugin — smoke tests
 *
 ...
 *
 * Run: npx tsx --test packages/vite-plugin/tests/vite-plugin-smoke.test.mjs
 */
...
describe("vite-plugin: smoke tests", () => {
  ...
  skip("exported functions are callable", () => {
    ...
    for (const name of ["elmoorx", "elmoorxPreset"]) {
      const v = mod[name];
