 ...
 *
 * Run: npx tsx --test packages/voice/tests/voice-smoke.test.mjs
 */
...
describe("voice: smoke tests", () => {
  ...
  skip("exported functions are callable", () => {
    ...
    for (const name of ["voice", "useVoice", "voiceCommand", "VoiceButton"]) {
      const v = mod[name];
  ...
  skip("Voice control - basic shape", () => {
