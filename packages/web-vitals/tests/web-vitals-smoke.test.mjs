/**
 * @elmoorx/web-vitals — smoke tests
 *
 ...
 *
 * Run: npx tsx --test packages/web-vitals/tests/web-vitals-smoke.test.mjs
 */
...
describe("web-vitals: smoke tests", () => {
  ...
  skip("exported functions are callable", () => {
    ...
    for (const name of ["trackWebVitals", "getCachedMetrics", "clearMetrics"]) {
      const v = mod[name];
  ...
  skip("Core Web Vitals - basic shape", () => {
